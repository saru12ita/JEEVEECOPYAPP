...
class JTitleSection extends StatefulWidget {
  const JTitleSection({super.key});

  @override
  State<JTitleSection> createState() => _JTitleSectionState();
}

class _JTitleSectionState extends State<JTitleSection> {
